...
to the Android platform without introducing any new restrictions:
  ...
  * **Compatibility**: Kotlin is fully compatible with JDK 6, ensuring that Kotlin applications can run on older
    Android devices with no issues.
  ...
  * **Learning Curve**: For a Java developer, getting started with Kotlin is very easy. For your first steps, you can rely
    on an automated Java to Kotlin converter included in the Kotlin plugin. [Kotlin Koans](/docs/tutorials/koans.html)
    guide you though the key features of the language with a series of interactive exercises.

## Users of Kotlin on Android
 ...
 * [Kotlin Android Extensions](http://kotlinlang.org/docs/tutorials/android-plugin.html) is a compiler extension
...
* The [Getting Started with Android and Kotlin](http://kotlinlang.org/docs/tutorials/kotlin-android.html) tutorial
